...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        _Distribution.__init__(
            self,
            {k: v for k, v in attrs.items() if k not in self._DISTUTILS_UNSUPPORTED_METADATA},
        )
    ...
    def warn_dash_deprecation(self, opt, section):
        ...
        if "-" in opt:
            warnings.warn(
                ...
                "versions. Please use the underscore name '%s' instead" % (opt, underscore_opt)
            )
        return underscore_opt
    ...
    def make_option_lowercase(self, opt, section):
        ...
        warnings.warn(
            ...
            "versions. Please use lowercase '%s' instead" % (opt, section, lowercase_opt)
        )
