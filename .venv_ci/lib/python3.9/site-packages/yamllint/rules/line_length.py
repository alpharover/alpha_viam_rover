...
ID = "line-length"
TYPE = "line"
CONF = {"max": int, "allow-non-breakable-words": bool, "allow-non-breakable-inline-mappings": bool}
DEFAULT = {
    "max": 80,
    "allow-non-breakable-words": True,
    "allow-non-breakable-inline-mappings": False,
    ...
    if line.end - line.start > conf["max"]:
        ...
        if conf["allow-non-breakable-words"]:
            ...
            if start != line.end:
                ...
                if conf["allow-non-breakable-inline-mappings"] and check_inline_mapping(line):
                    return
