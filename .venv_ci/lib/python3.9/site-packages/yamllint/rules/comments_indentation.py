...
def check(conf, comment):
    ...
    if comment.column_no - 1 != prev_line_indent and comment.column_no - 1 != next_line_indent:
        yield LintProblem(comment.line_no, comment.column_no, "comment not indented like content")
